      ...
      <div className="flex flex-col items-center gap-[20px] rounded-[20px] bg-black p-[20px] min-[1440px]:h-fit min-[1440px]:w-full min-[1440px]:flex-row min-[1440px]:p-[50px]">
        ...
        {cards.map((card, index) => (
          <div
            ...
            className={cn(
              "relative flex flex-col gap-[10px] rounded-[15px] bg-[#110C15] px-[20px] pb-[20px] pt-[15px] min-[1440px]:h-[323px] min-[1440px]:w-[64.5%] min-[1440px]:gap-[20px] min-[1440px]:px-[60px] min-[1440px]:pb-[26.5px] min-[1440px]:pt-[36.5px]",
