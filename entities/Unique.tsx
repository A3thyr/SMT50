...
export default function Unique() {
  ...
  return (
    <div className="flex flex-col items-center gap-[40px] pt-[100px] font-montserrat min-[1280px]:items-start min-[1280px]:gap-[50px] min-[1280px]:pt-[450px] min-[1750px]:pt-[250px]">
      <h2 className="bg-text-bluenwhite-radgrad bg-clip-text text-center font-manrope text-[30px] font-medium leading-[36px] text-transparent min-[1280px]:text-start min-[1280px]:text-[50px] min-[1280px]:leading-[60px]">
        What makes the SMT50 unique
      </h2>
      <div className="flex flex-col items-center gap-[20px] rounded-[20px] bg-black p-[20px] min-[1280px]:h-fit min-[1280px]:w-full min-[1280px]:flex-row min-[1280px]:p-[50px]">
        <div className="flex flex-col gap-[5px] min-[1280px]:w-[41%]">
          {buttons.map((button, index) => (
            <button
              key={`buttons-${index}`}
              onClick={() => setIsSlide(index)}
              className="rounded-[10px] border-[1px] border-transparent bg-[#110C15] px-[30px] py-[15px] text-start text-[15px] font-normal leading-[18px] text-white hover:border-[1px] hover:border-dashed hover:border-[#8D23F7] focus:border-[1px] focus:border-dashed focus:border-[#fff] min-[1280px]:text-[24px] min-[1280px]:leading-[28.8px]"
            >
              {button.text}
            </button>
          ))}
        ...
        {cards.map((card, index) => (
          <div
            ...
            className={cn(
              "relative flex flex-col gap-[10px] rounded-[15px] bg-[#110C15] px-[20px] pb-[20px] pt-[15px] min-[1280px]:w-[64.5%] min-[1280px]:gap-[20px] min-[1280px]:px-[60px] min-[1280px]:pb-[26.5px] min-[1280px]:pt-[36.5px]",
          ...
          >
            ...
            <p className="text-[15px] font-normal leading-[22.5px] text-[#FFFFFFCC] min-[1280px]:text-[18px] min-[1280px]:leading-[27px]">
              {card.description}
            </p>
          </div>
        ))}
