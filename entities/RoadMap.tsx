...
export default function RoadMap() {
  return (
    <div className="z-[999] flex flex-col items-center pt-[100px] min-[1440px]:w-full">
      ...
      <div className="flex flex-col gap-[20px] pt-[40px] min-[1440px]:w-full">
        <div className="relative flex flex-col items-center min-[1440px]:w-full">
          <div className="absolute h-[20px] w-[240px] rounded-[100px] bg-[#FF00A8]"></div>
          <div className="mt-[5px] flex flex-col items-center gap-[10px] rounded-[20px] border-[2px] border-solid border-[#ffffff1A] bg-transparentCardGrad px-[30px] pb-[22px] pt-[30px] text-center backdrop-blur-[25px] min-[1440px]:w-full min-[1440px]:flex-row">
            <h3
              className={cn(
                "text-[50px] font-extrabold leading-[60px] text-transparent min-[1440px]:text-[80px] min-[1440px]:leading-[96px]",
                "h3StrokePink",
              )}
            >
              Q4 2024
            </h3>
            <div className="mt-[30px] flex w-[336px] flex-col items-center gap-[10px] min-[1440px]:w-fit">
        ...
        <div className="relative flex flex-col items-center min-[1440px]:w-full">
          <div className="absolute h-[20px] w-[240px] rounded-[100px] bg-[#8D23F7]"></div>
          <div className="mt-[5px] flex flex-col items-center gap-[10px] rounded-[20px] border-[2px] border-solid border-[#ffffff1A] bg-transparentCardGrad px-[30px] pb-[22px] pt-[30px] text-center backdrop-blur-[25px] min-[1440px]:flex-row">
            <h3
              className={cn(
                "text-[50px] font-extrabold leading-[60px] text-transparent min-[1440px]:text-[80px] min-[1440px]:leading-[96px]",
                "h3StrokePurple",
        ...
        <div className="relative flex flex-col items-center min-[1440px]:w-full">
          <div className="absolute h-[20px] w-[240px] rounded-[100px] bg-[#0047FF]"></div>
          <div className="mt-[5px] flex flex-col items-center gap-[10px] rounded-[20px] border-[2px] border-solid border-[#ffffff1A] bg-transparentCardGrad px-[30px] pb-[22px] pt-[30px] text-center backdrop-blur-[25px] min-[1440px]:flex-row">
            <h3
              className={cn(
                "text-[50px] font-extrabold leading-[60px] text-transparent min-[1440px]:text-[80px] min-[1440px]:leading-[96px]",
            ...
            <div className="mt-[30px] flex w-[336px] flex-col items-center gap-[10px] min-[1440px]:grid min-[1440px]:w-fit min-[1440px]:grid-flow-col min-[1440px]:grid-rows-2">
              <div className="flex w-full flex-row items-center justify-start gap-[10px] rounded-[50px] border-[1px] border-dashed border-[#FFFFFF66] px-[20px] py-[10px] min-[1440px]:w-fit">
                <TimerSvg />
                <h4 className="text-[15px] font-normal leading-[18px] text-white min-[1440px]:text-[20px] min-[1440px]:leading-[24px]">
                  Further development of the Index
